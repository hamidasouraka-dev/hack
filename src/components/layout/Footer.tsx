...
export function Footer() {
  return (
    <footer className="py-24 px-8 border-t border-brand/5 bg-white/20 mt-20">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-12">
          <div>
            <h5 className="font-bold text-ink text-sm uppercase tracking-widest mb-6">Produit</h5>
          ...
          <div>
            <h5 className="font-bold text-ink text-sm uppercase tracking-widest mb-6">Compagnie</h5>
            <ul className="space-y-4 text-sm text-muted font-medium">
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-10 border-t border-brand/5 flex flex-col md:flex-row items-center justify-between gap-6 opacity-40">
        ...
        <div className="flex gap-8 text-[10px] font-bold text-muted uppercase tracking-[0.2em]">
          <span>Lagos</span>
          <span>Cotonou</span>
          <span>Dakar</span>
          <span>Abidjan</span>
